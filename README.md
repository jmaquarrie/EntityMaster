...
9. Need additional domain tags? Open the ⚙️ settings modal and use the new **Custom Domains** section to add or delete labels. Newly created domains immediately appear in every system panel, the bulk editor, and the domain filter chips (and they are included when you save or share a diagram).
